<?php
	...
	if(isset($_POST['repeatedEmail']))
	{
		...
		$secretKey = "6Lea90UeAAAAAFc4AM0vtCzPQ56XpjlsJ_R62fUv";
...
<body class="text-center d-flex flex-column min-vh-100">
	...
	<main class="form-signin pb-4 mb-5">
		<form method="post">
			...
			<div class="row empty-row mb-3"></div>
			<div class="row mb-3">
				<div class="d-flex justify-content-center g-recaptcha" data-sitekey="6Lea90UeAAAAAKTT5SKVFa2OLi10wdu8uDntuRSd"></div>
				<?php
